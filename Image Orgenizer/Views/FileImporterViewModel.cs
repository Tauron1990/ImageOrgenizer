...
namespace ImageOrganizer.Views
{
    ...
    public class FileImporterViewModel : MainViewControllerBase
    {
        ...
        public void StartImport()
        {
            ...
            Operator.ImportFiles(input).ContinueWith(t =>
            {
                ...
                if (ex == null)
                    ...
                    Dialogs.ShowMessageBox(MainWindow, $"{ex.GetType()} -- {ex.Message}", "Error", MsgBoxButton.Ok, MsgBoxImage.Error, null);
            });
        }
        ...
        public override void BuildCompled()
        {
            ...
            CurrentProvider = ProviderItems.First(p => p.Id == NonProvider.ProviderNon);
        }
